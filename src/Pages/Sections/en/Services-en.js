...
const ServicesEN = () =>  {
  ...
  const ServicesDetails = [
    ["Dynamic Excel dashboards", "Power BI Dashboards", "Using advanced Microsoft Power tools"],
    ["Data cleaning and modeling", "Data automatization",  "Data visualization",  "Business insight"],
    ["Landing pages", "Responsive format",  "Animations and 3D design "]
  ];
  ...
  const getServicesDetails = (prop) => {
    ...
    return (
      <section id="services" className="md:pt-24 font-body text-white w-full h-full bg-slate-800 md:pb-36 ">
        <h1 className="text-center w-full md:text-8xl text-7xl">
          <p>Services</p>
        </h1>
